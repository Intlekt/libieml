...
TEST(ieml_grammar_test_case, inflection_decl_valid_noun_test_noun)                   TEST_PARSE_NO_ERRORS(R"(@rootparadigm type:inflection "O:M:.".@inflection en:test class:NOUN "a.". @word "we.". @node fr:test2 (0 ~test #"we.").)");
TEST(ieml_grammar_test_case, inflection_decl_valid_noun_test_noun_not_root)          TEST_PARSE_NO_ERRORS(R"(@rootparadigm type:inflection "O:M:.".@inflection en:test class:NOUN "a.". @word "we.". @node en:test2 (0 ~test #"we."). @node fr:test3 (0 #test2, 1 ~test #test2).)");
TEST(ieml_grammar_test_case, inflection_decl_valid_noun_test_verb)                   TEST_PARSE_NO_ERRORS(R"(@rootparadigm type:inflection "O:M:.".@inflection en:test class:VERB "a.". @word "we.". @node fr:test2 (0 ~test #"we.").)");
...
TEST(ieml_grammar_test_case, paradigm_auxiliary)                                     TEST_PARSE_NO_ERRORS(R"(@rootparadigm type:auxiliary "O:M:.".@word "wa.". @auxiliary en:aux0 role:1 "e.". @auxiliary en:aux1 role:1 "o.". @node en:ss0 (0 #"wa.", 1 *aux0 #"wa."). @node en:ss1 (0 #"wa.", 1 *aux1 #"wa."). @node en:invariant (0 #"wa."). @paranode en:test2 1d:/#/1 (0 #"wa.", 1 {*aux0 ; *aux1} #"wa.").)");
TEST(ieml_grammar_test_case, paradigm_inflection)                                    TEST_PARSE_NO_ERRORS(R"(@rootparadigm type:INFLECTION "O:M:.".@word "wa.". @inflection en:infl0 class:NOUN "e.". @inflection en:infl1 class:NOUN "o.". @node en:ss0 (0 #"wa.", 1 ~"e." #"wa.").@node en:ss1 (0 #"wa.", 1 ~"o." #"wa."). @node en:invariant (0 #"wa."). @paranode en:test2 1d:/#/1 (0 #"wa.", 1 {~infl0; ~infl1} #"wa.").)");
TEST(ieml_grammar_test_case, inflection_list_word)                                   TEST_PARSE_NO_ERRORS(R"(@rootparadigm type:INFLECTION "O:M:.".@word "wa.". @inflection en:infl class:NOUN "e.". @node en:test (0 #"wa.", 1 ~"e." #"wa.").)");
...
TEST(ieml_grammar_test_case, junction_word)                                          TEST_PARSE_NO_ERRORS(R"(@rootparadigm type:JUNCTION "O:M:.". @word "wa.". @word "wo.". @junction en:junc "e.". @node en:test (0 #"wa.", 1 &"e." [#"wa." #"wo."]).)");
...
// ERRORS
TEST(ieml_grammar_test_case, no_root)                                                TEST_PARSE_ERRORS(R"(@rootparadigm type:inflection "O:M:.".@word "wa.". @inflection en:noun class:NOUN "a.". @component en:test (1 ~noun #"wa.") .)");
TEST(ieml_grammar_test_case, extra_comma_in_phrase_line)                             TEST_PARSE_ERRORS(R"(@rootparadigm type:inflection "O:M:.".@word "wa.". @inflection en:noun class:VERB "a.". @component en:test (0 #(0 ~noun #"wa."),) .)");
TEST(ieml_grammar_test_case, language_string_with_old_decl)                          TEST_PARSE_ERRORS(R"(@rootparadigm type:inflection "O:M:.".@word "wa.". @inflection en:noun class:VERB "a.". @component fr'test' (0 #(0 ~noun #"wa."),) .)");
TEST(ieml_grammar_test_case, language_string_starts_with_digits)                     TEST_PARSE_ERRORS(R"(@rootparadigm type:inflection "O:M:.".@word "wa.". @inflection en:noun class:VERB "a.". @component en:0 (0 #(0 ~noun #"wa."),) .)");
TEST(ieml_grammar_test_case, invalid_translation_id)                                 TEST_PARSE_ERRORS(R"(@rootparadigm type:inflection "O:M:.".@word "wa.". @inflection en:noun class:VERB "a.". @component rr:test (0 ~noun #"wa.").)");
...
TEST(ieml_grammar_test_case, invalid_non_paradigm)                                   TEST_PARSE_ERRORS(R"(@word "wa.". @word "we.". @paranode en:test2 1d:/#/0 (0 #"wa.").)");
...
TEST(ieml_grammar_test_case, paradigm_empty_invariant)                               TEST_PARSE_ERRORS(R"(@word "wa.". @word "we.". @paranode en:test2 1d:/#/0 (0 {#"wa."; #"we."}).)");
TEST(ieml_grammar_test_case, paradigm_invalid_invariant)                             TEST_PARSE_ERRORS(R"(@word "wa.". @word "we.". @node en:invariant (1 #"wa."). @paranode en:test2 1d:/#/0 (0 {#"wa."; #"we."}, 1 #"wa.").)");
